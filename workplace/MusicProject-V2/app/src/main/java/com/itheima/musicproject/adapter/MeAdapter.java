package com.itheima.musicproject.adapter;
...
import com.itheima.musicproject.activity.BaseActivity;
...
public class MeAdapter extends BaseExpandableListAdapter {
    ...
    public com.itheima.musicproject.domain.List getChildData(int position, int childPosition) {
    ...
    class ChildViewHolder{
        ...
        public void setData(com.itheima.musicproject.domain.List data) {
